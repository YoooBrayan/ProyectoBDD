    ...
    insert into empleado values 
        (9000, 1024, 'Pablo', 3000000, '1990-05-12', '2020-01-01', 1, 'Libreria Pasto'),
        (1100, 1025, 'Daniel', 2000000, '1992-06-11', '2020-02-01', 2, 'Libreria Pasto'),
        (3100, 1026, 'Adrian', 3000000, '1991-05-14', '2020-01-01', 1, 'Libreria Cali'),
        (4100, 1027, 'Angela', 1500000, '1994-07-17', '2020-05-12', 2, 'Libreria Pasto'),
        (5100, 1028, 'Henry', 2000000, '1991-02-13', '2020-06-02', 2, 'Libreria Pasto'),
        (6100, 1029, 'Oliver', 1000000, '1992-06-17', '2020-03-01', 2, 'Libreria Cali'),
        (7100, 1034, 'Alejandra', 1600000, '1994-09-13', '2020-01-06', 2, 'Libreria Cali'),
        (8100, 1035, 'Simon', 1800000, '1996-12-23', '2020-01-31', 2, 'Libreria Cali');
